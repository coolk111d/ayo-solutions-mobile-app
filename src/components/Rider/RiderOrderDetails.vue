<template>
        ...
        <ion-footer>
            <ion-toolbar>
                <ion-button color="tertiary" @click="dismissModal">Mark as Delivering</ion-button>
            </ion-toolbar>
        </ion-footer>
</template>

<script lang="ts">
import { IonContent, IonCard, IonGrid, IonButton, modalController } from '@ionic/vue';
...
export default defineComponent({
    ...
    components: { IonContent, IonCard, IonGrid, IonButton , GMap },
    setup() {
